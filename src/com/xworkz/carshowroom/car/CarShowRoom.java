...
public class CarShowRoom {
	...
	//This method will update the varient of the car in ENUM class by using index
	...
	//carAtIndex() method will display the values at particular index by using index reference
	...
	//displayByModel() this method will display the values by using the model name
	...
	//This deleteByIndex() will delete the particular index by using index reference
	...
	//deleteByModel() will null the index by using the model name 
